...
void cmd_research_test(int argc, char **argv)
{
	...
	else if (anx_strcmp(argv[1], "day-072") == 0)
		ret = anx_research_day072();
	else if (anx_strcmp(argv[1], "day-073") == 0)
		ret = anx_research_day073();
	else if (anx_strcmp(argv[1], "day-074") == 0)
		ret = anx_research_day074();
	else if (anx_strcmp(argv[1], "day-075") == 0)
		ret = anx_research_day075();
	else if (anx_strcmp(argv[1], "day-076") == 0)
		ret = anx_research_day076();
	else if (anx_strcmp(argv[1], "day-077") == 0)
		ret = anx_research_day077();
	else if (anx_strcmp(argv[1], "day-078") == 0)
		ret = anx_research_day078();
	else if (anx_strcmp(argv[1], "day-079") == 0)
		ret = anx_research_day079();
	else if (anx_strcmp(argv[1], "day-080") == 0)
		ret = anx_research_day080();
	else if (anx_strcmp(argv[1], "day-081") == 0)
		ret = anx_research_day081();
	else if (anx_strcmp(argv[1], "day-082") == 0)
		ret = anx_research_day082();
	else {
