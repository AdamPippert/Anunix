/*
 * anx/icm.h — Information Context Management over State Objects (RFC-0027).
 *
...
/* Reserved anno.icm.* annotation keys (RFC-0027 Section 4.1). */
 ...
 * role is deliberately absent — role is local to the consumer (RFC-0027 4.2).
 * `published` carries a release URI on published artifacts only (RFC-0027 4.1,
 ...
 * versioned" (RFC-0027 9.3), this is intended for sealed objects; the kernel
 ...
 * published" view, RFC-0027 9.3). Same return contract as anx_icm_catalog().
 */
