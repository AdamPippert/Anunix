 ...
 * (world model divergence), goal alignment (keyword matching), constraint
...
/* Number of world-model proposals generated per iteration */
 ...
 *   1. Create an ANX_OBJ_BELIEF_STATE (world model observe + encode)
 *   2. Generate ANX_EBM_PROPOSALS_PER_ITER world-model proposals
 ...
 *
 * Non-fatal without a world model: proceeds with neutral energies.
