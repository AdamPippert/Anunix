/* font_data.h — VGA 8x16 glyph bitmap for ASCII 32-127.
 * Auto-generated from kernel/lib/font.c. Do not edit.
 * FONT_GLYPH[n][row]: glyph for ASCII (n+32), 16 rows, MSB=left.
 */
#ifndef ANX_FONT_DATA_H
#define ANX_FONT_DATA_H

static const uint8_t FONT_GLYPH[96][16] = {
    ...
    /* 127 '?' */ { 0x00, 0x00, 0x7C, 0xC6, 0xC6, 0x0C, 0x18, 0x18, 0x18, 0x00, 0x18, 0x18, 0x00, 0x00, 0x00, 0x00 },
};

#endif /* ANX_FONT_DATA_H */
